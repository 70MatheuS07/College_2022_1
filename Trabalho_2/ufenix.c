...
int main(int argc, char *argv[])
{
  ...
  while (1)
  {
    ...
    {
      printf("Operacao invalida, tente uma das opcoes listadas\n\n");
    }
...
/**
 * @brief Le uma palavra de entrada e armazena na string.
 * 
 * 
 * @param string 
 * @return char (server para conferir se a linha de comando terminou).
 */
char LehCaracterCaracter(char *string)
{
  int i = 0;
...
/**
 * @brief Coleta os argumentos da linha de comando até o '\n'
 * 
 * @param argc 
 * @param argv 
 * @param caracterPosComando 
 * @return int (retorna quantidade de argumentos dentro de argv)
 */
int ColetaArgumentos(int argc, char **argv, char caracterPosComando)
{
  char *argumento = NULL;
